...
//  MusicMVC
//
//  Created by Emilien Stremsdoerfer on 11/02/17.
...
open class Future<T> {
    ...
    private var errorHandler: ((LocalizedError) -> Void)?
    ...
    @discardableResult
    func onError(_ handler: @escaping ((LocalizedError) -> Void)) -> Future {
     ...
     */
    func onUploadProgress(_ handler:@escaping((_ receivedSize: Int64, _ expectedSize: Int64) -> Void)) {
